...
public class ArrowComponent extends Component {
    ...
    public ArrowComponent(double directionX, double directionY, int damage, double speed) {
    ...
    public void onUpdate(double tpf) {
        ...
        for (Entity enemy : new ArrayList<>(getGameWorld().getEntitiesByType(EntityType.ENEMY))) {
            ...
            if (enemyComponent != null && enemyComponent.isAlive() && intersects(enemy)) {
                enemyComponent.takeDamage(damage, directionX);
                entity.removeFromWorld();
                return;
            }
        }
